...
import { archJournal } from 'utils/constants';
import { Rs3Activity, Rs3Skill } from 'features/RS3/rs3Types';

export const isNullUndefinedOrWhitespace = (text: string | null) => {
...
export const skillIcon = (id: number) => {
	return <img style={{ width: '25px' }} src={imgArray[id]} alt="skill con" />;
};
